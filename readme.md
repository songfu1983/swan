...
| macOS Mojave | [swift-5.1.5-RELEASE](https://github.com/apple/swift/releases/tag/swift-5.1.5-RELEASE) | [v1.5.4](https://github.com/wala/WALA/releases/tag/v1.5.4) |
| Linux (Ubuntu 18.04) | [swift-5.1.5-RELEASE](https://github.com/apple/swift/releases/tag/swift-5.1.5-RELEASE) | [v1.5.4](https://github.com/wala/WALA/releases/tag/v1.5.4) |

Note: SWAN currently uses Xcode 11. It can be obtained through [here](https://xcodereleases.com).
